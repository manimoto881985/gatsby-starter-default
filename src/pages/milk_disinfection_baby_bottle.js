...
const IndexPage = () => (
  <Layout>
    ...
    <p>
      ミルクは<a href="https://amzn.to/2WBtydp" target="_blank" rel="noopener noreferrer">「アイクレオ バランスミルク」</a>をあげている。<br />
      <a href="https://amzn.to/2WBtydp" target="_blank" rel="noopener noreferrer">アイクレオ バランスミルク</a>は他社製品と比較して成分が母乳に近いということで選んだ。
    </p>
    <p>
      <a href="https://amzn.to/2WBtydp" target="_blank" rel="noopener noreferrer">アイクレオ バランスミルク</a>を買うと、20mlスプーンが付いてくる。<br />
      ...
      アイクレオのホームページに<a href="https://www.icreo.jp/cp/spoon/" target="_blank" rel="noopener noreferrer">「50mlスプーン申し込み」</a>から入手できる。必須アイテムだ。
    </p>
    ...
    <p>
      <a href="https://amzn.to/2K7eLAC" target="_blank" rel="noopener noreferrer">タイガー魔法瓶の70℃に温度設定できる電気ポット</a>はマストバイだ。<br />
    ...
    <p>
      哺乳瓶消毒は<a href="https://amzn.to/2WorK2z" target="_blank" rel="noopener noreferrer">「ピジョンの電子レンジスチーム」</a>を使用して電子レンジ消毒している。<br />
    ...
    <p>
      ...
      最初は<a href="https://akachan.omni7.jp/detail/436002000" target="_blank" rel="noopener noreferrer">授乳用品セット</a>に付属していた2本を使用していた。しかし2本だと2回に1度消毒する必要がある。これが地味にツラかった。<br />
